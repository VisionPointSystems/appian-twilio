...
public class DeleteTaskRouterWorker extends AppianSmartService {

	private static final Logger LOG = Logger
			.getLogger(DeleteTaskRouterWorker.class);
	...
	public void run() throws SmartServiceException {
		...
		success = TwilioWorker.delete(workerSid, workspaceSid, accountSid, authToken);

	}

	public DeleteTaskRouterWorker(SmartServiceContext smartServiceCtx, SecureCredentialsStore scs) {
		super();
